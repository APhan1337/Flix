...
//  Flix
//
//  Created by Alex V Phan on 1/23/20.
    ...
    override func viewDidLoad() {
        ...
        let task = session.dataTask(with: request) { (data, response, error) in
           ...
           if let error = error {
            ...
            // Look into that dataDictionary, and get the results.
            // Movies are successfully stored in a property that is available to other functions.
